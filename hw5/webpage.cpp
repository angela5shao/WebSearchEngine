...
MySetString WebPage::incomingLinkNames() const {
	return inLinkNames_;
}
void WebPage::setIncomingLinkNames(MySetString set) {
	inLinkNames_ = set;
}
...
MySetString WebPage::outgoingLinkNames() const {
	return outLinkNames_;
}
void WebPage::setOutgoingLinkNames(MySetString set) {
	outLinkNames_ = set;
}
