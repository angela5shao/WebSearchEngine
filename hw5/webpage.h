...
class WebPage
{
 public:
  ...
  MySetString incomingLinkNames() const;
  void setIncomingLinkNames(MySetString);
  ...
  MySetString outgoingLinkNames() const;
  void setOutgoingLinkNames(MySetString);
 ...
 private:
  ...
  std::string fname_;
  MySetString wordSet_;

  MySetString outLinkNames_;
  MySetString inLinkNames_;

  MySetWebPage outWebSet_;
  MySetWebPage inWebSet_;
